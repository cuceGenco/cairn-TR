...
- **Amaç**: Zindanın orijinal amacının ne olduğunu ve bugün ne için kullanıldığını düşünün. Zindan sakinlerinin ve hedeflerine yer vererek bir zindanın tarihini gösterin. Bazen bir zindanın birden çok amacı olur ve bunlar çatışarak sakinleri arasında gerilim yaratabilir.
- **Katlar**: Zindanın inşası ve amacının bir parçası olarak mantıklı olmaları gerekse de, artan katlar aynı zamanda artan tehlikeyi temsil etmelidir. Her katta, oyuncuları daha fazla keşif riski ile potansiyel ödül arasında bir değerlendirme yapmaya itmeye çalışın.
...
- **Hazine**: Sadece altının ötesinde; bilgi, müttefikler, ticaret malları ve eserler gibi çeşitli hazineler ekleyin. Hazineye anlatı öğeleri ekleyerek parasal olmayan yönlerini artırın.
...
- **Klikler**: Klikler hem karakterlerle hem de birbirleriyle etkileşime geçmeli, karakterlerin eylemlerinden bağımsız olarak kendi başlarına hareket etmelidir. İstismar edilebilecek hiyerarşiler ve bölünmeler verin.
...
- **Oda Kodlama**: Bir odanın en önemli yönlerini (tipik olarak bariz tehditler veya NPC'ler) vurgulayın. Partinin çevreye yönelmesine yardımcı olan öğeleri betimleyin. Somut olun, ancak karakterlerin nasıl _hissetmesi_ gerektiğini betimlemekten kaçının. Sadece şimdi _olan_ şeyi betimleyin. Burada bir tarih varsa, karakterler bunu oyun içinde keşfedecektir. Her odayı adlandırın!
- **Karşılaşma Tabloları**: Keşfi gergin ve öngörülemez kılmak için zindanı canlı hissettirecek rastgele olaylar oluşturun; partiler gezgin canavarlar, klikler, NPC'ler veya yaklaşan bir tehdidin işaretleriyle karşılaşabilir. Zorluklar, dinlenme anları veya rol yapma fırsatları sağlamaya çalışın.
...
| **1**   | Atasal Törenler              | Yitmiş Bir Kahraman    |
| **2**   | Büyülü Kütüphane             | Tarikat     |
| **3**   | Astral Ticaret Merkezi       | Unutulmuş Bir İmparatorluk |
| **4**   | Canavarsı Yaratımlar           | Uzun Zaman Önce Ölmüş Bir Şair |
...
| **16**  | Gözlemevi                   | Tersyüz Olmuş Astrologlar |
| **17**  | Hac Mekanı                    | Mafya Aileleri          |
| **18**  | Nadir Eserlerin Korunması   | Gösterişli Tüccarlar    |
| **19**  | Gizli Buluşma Yeri          | Ölü Bir Tanrının Hacıları |
...
| **15**  | Zehirlenmiş      | Belirsizleştirme  |
| **16**  | Yanmış/kavrulmuş | Canavarlarca İstila Edilmiş |
...
Çoğu zindanda _yaşayan_ ve orayı yuva edinen yaratıklar bulunur. Aşağıdaki tablo, zindandaki akıllı yaratıkların herhangi birinin veya tamamının genel tavrını betimlemek için kullanılabilir. Özellikler tablosunda zar atın ve sonuçları not edin. Bu, zindanda bulunan yaratıkların genel tavrını betimler.

Bu arada, her zindanda diğerlerinden sıyrılan en az bir NPC bulunmalıdır. Bu tür karakter zindan hayatını diğer her şeye tercih eder, ancak yine de benzerlerinden farklı davranırlar. Partinin etkileşime geçebileceği, ticaret yapabileceği, işe alabileceği, yardım edebileceği vb. NPC'ler olmalıdırlar. Bu garip yaratıklar, zindanın diğer sakinleri ve klikleriyle derinden ilgili veya tamamen tarafsız olabilir. Tekrar Özellikler tablosunda zar atın, sonuçları defterinize not edin ve aklınızda şu soruları tutun:

_"Zindanı işgal eden yaratıklar ve klikler hakkında ne biliyoruz?"_

_"Klikler neyi başarmaya çalışıyor ve önlerindeki engel ne?"_
...
| **13**  | Dirençli        | Alaycı  |
| **14**  | Bilgili         | Bencil        |
| **15**  | Kendi Ayakları Üzerinde Kuvvetli | Şüpheci       |
| **16**  | Sağlam          | İnatçı        |
...
- [Zindan Zar Düşürme Tablosu](#zindan-zar-düşürme-tablosu) kullanılarak, üst yüze gelen sonuçları sayfaya yazın. Örneğin, **4** sayısı **Özel** bir odayı belirtir; bunu haritada "Ö" harfiyle belirtebilirsiniz.
...
- **Koşullu** yollar engellenmiş olabilir veya geçmek için özel araçlar (gizli kollar, tırmanış ekipmanı vb.) gerektirir. Oyuncular için bir harita veya rehber olmadan gezinmek imkansız bile olabilir. _Üzeri çizili çizgi ile temsil edilir._
...
Canavarlar, bir zindanda yaşayan tehlikeli yaratıklardır. Bu, varsayılan olarak davetsiz misafirlere saldıracağı anlamına gelmez! Canavarlar, karakterlerin onları bulması için sadece "etrafta bekleyen" varlıklar değildir; aksine, sadece bir sonraki yemeklerini arıyor olsalar bile kendi istekleri ve hedefleri vardır. Bazı canavarlar konuşabilir, mantık yürütebilir ve hatta merhamet dileyebilir. _Canavarlar insan da olabilir._
...
Bilgi içeren odaları, zindanın teması üzerine inşa edilmeli, değerli bir içerik sağlamalı veya karakterleri bir NPC veya Klikle bağlamalıdır. Partiyi birleştiren veya onları görevleriyle karşı karşıya getiren bir ikilem yaratabilirler. En azından, bu odalar bir merak unsuru olarak işlev görmeli ve deneyime tehlike ve bulmaca çözmenin ötesinde akılda kalıcı bir şey eklemelidir. Tabii ki, karakterler bu odaların tehlike veya zorluk içermediğini bilmemelidir. Bu, zindandaki gerilimi artırmaya yardımcı olurken, potansiyel bir dinlenme ve anlatıyı büyütme fırsatı sunar.
...
| ------- | ----------- | ----------- |
| **d20** | **Özel**    | **Özellik** |
| **1**   | Kitaplar    | Yaşlandırır      |
| **2**   | Köprü       | Alarma Geçirir    |
...
Bu örnek için, Ortam Tohumları bölümünde açıklanan yöntemler kullanılarak oluşturulmuş bir İlgi Noktası'na baktığımızı varsayalım. İlgili sonuçlarımız şunlardı:
...
_Yoğun, örtülü bir ormanın içinde, tamamen taşlaşmış odunlardan yapılmış bir tapınak yatıyor. Eolith'in Çocukları adlı fanatik bir tarikat tarafından inşa edilen tapınak, herhangi bir bitkiyi taşa çevirebilen kadim bir Emanet olan Ağaç Çeviren'i korumak için tasarlanmıştır. Tarikat sonunda iki karşıt kliğe bölünür ve düello eden ritüelleri çarpıştığında tapınak parçalanır, her Klik sadece yarısını alır. Bugün bu hiziplerin torunları hâlâ kontrol, yıkım ve kefaret için mücadele etmekte, ancak güç dengesizlikleri ve kadim gelenek tarafından engellenmektedir._
...
_Lacivert Lejyon, atalarının eylemleri karşısında büyük bir utanç duyar ve orijinal Emanet yok edilirse tapınağın yeniden iyileşeceğine ve utançlarının silineceğine inanır. Ne yazık ki, köklü bir gelenek, geçmişin hatalarından kaçınmak için bütün üyelerin Emanet'i aramasını yasaklar._
...
_Zindanın derinliklerinde **Ağaç Çeviren** adlı bir Emanet gizlidir. Sadece temas yoluyla ağaçları, ahşabı veya diğer bitki yaşamını taşlaştırabilir. Düzgün bir şekilde kontrol altına alınmazsa, tüm bir ormanı çorak araziye dönüştürebilir!_
...
- Partiye, gizlice hareket eden Lacivert Lejyon'dan bir ajan temas kurar. Parti, tapınakta kaybolmuş büyük güce sahip bir eşya olan **Ağaç Çeviren**'i bulup yok edecektir. Görev gizli kalmalıdır ve herhangi bir Hizbin üyeleri muhtemelen onlara karşı duracaktır. Karakterlere 1000 altın (toplam) ödenecektir.
...
- **Işık**: Tüm odalarda duvarlara duran şamdanlar vardır. Hiçbiri yanmıyor.
- **Koku**: Nemli, kir ve kükürt kokusu.
...
- **Ağaçlar**: Taşlaşmış. Bembeyaz.

### 1 - Yemek Salonu

**Bilgi**: _Yemek Salonu_. _Koku_.

Uzun, rustik **masalar** yatay sıralar halinde dizilmiştir. Havada sebze kökleri ve karanfil **kokusu** esintisi vardır.
...
- **Siyah Sandalye**: Temiz ve parlak, sanki yeni gibi. Sandalyenin alt kısmına bilek kayışları bağlıdır ve sandalye zemine cıvatalanmıştır.
...
Bir Basilisk, odanın Doğu tarafında bir **duvar** üzerine yapılmış bir yuvada uyuyor. Odanın merkezinde, zeminden **tavana** kadar uzanan uzun bir cam **kafes** bulunur. Güney duvarına bağlı uzun, kırık bir **zincir** vardır.
...
- Parlatılmış odun yapımı beyaz bir çubuk. Çubuğun herhangi bir canlı bitkiye dokundurulması onu taşlaştırır. 3 kullanım.
- **Şarj Doldurma**: Çubuğu bir gün ve bir gece boyunca güçlü alevlerde yakın. Külleri saf kaynak suyuna dökün. Çubuk yeniden şekillenecektir.