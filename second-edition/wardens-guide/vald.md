...
- _Lector_: Bir acemi, kendini kanıtlayana kadar _Junior Lector_ olarak kabul edilir, ardından _Yüksek Lector (High Lector)_ unvanı verilir. Sadece ikincisi işlerinde Emanetleri kullanabilir.
- _Keeper (Koruyucu)_: Tipik bir asker veya paralı askere benzer şekilde, bir Geçit'in koruyucusu.
- _Archivist (Arşivci)_: _Büyük Arşivci (Grand Archivist)_ tarafından yönetilen, saygın bir araştırmacı veya kütüphaneci.
- _Chamberlain (Hazinedar)_: Korunmaları, dağıtılmaları ve keşfedilmeleriyle görevli bir Emanet ustası.
- _Inquisitor (Sorgucu)_: Tarikat içindeki en yüksek rütbeli konum, üçlü bir yönetim (Üçler olarak adlandırılır) olarak gücü paylaşır ve yalnızca _Dokuzlar'a_ karşı sorumludur.

### Sınır Muhafızları (Marchguard)

Diyarın kıyılarında ve Orman'ın ötesinde o kadar vahşi, o kadar tehlikeli bir yer vardır ki, oraya yalnızca aşırı cesur veya aşırı aptal olanlar adım atar. Bu toprakların sınırları zamanın geçişiyle birlikte sürekli değişir, büyür ve dönüşür. Ve böylece Sınır Muhafızları doğdu. Muhafızların ne zaman oluştuğunu veya onu kimin yarattığını kimse hatırlamaz, ancak herkes amaçlarını bilir: diyarı sınırı geçebilecek herhangi bir saldırıdan korumak ve rehbersiz geçmeye çalışanları engellemek.

Muhafızlar, hiçbir krala boyun eğmez, hiçbir dini tanımaz ve kendilerininkinden başka hiçbir yasaya uymaz. Merkezi bir liderlikten bile yoksundurlar, bunun yerine dış müzakerelerde onları temsil etmesi için maskeli bir gönüllü sağlarlar. Yeni üyeler, ölümün kendisi dışında herkes için kaçınılmaz olduğu söylenen o kadar güçlü bir Kan Yemini (Blood Oath) alırlar. Tabii ki, Muhafızlara katılmak nadiren bir seçimdir, çünkü safları büyük ölçüde eski haydutlar, rezil olmuş bilginler, ihmal edilmiş şövalyeler, soysuz korucular ve benzerlerinden oluşur. Elbette, böyle olması gerekir. Bu tür bilinemez dehşetlere karşı durmak için hayatlarını isteyerek adayacak başka kim olabilir ki?

Kan Tazıları (Bloodhounds), özel övgüler almış veya davalarına gerçekten inandıklarını göstermiş Muhafız üyeleridir. Bu avcılar, tek bir görev amacını benimsemiştir: Yemini uygulamak. Bir casus, muhbir ve ajan ağı kullanarak, Muhafızlardan kaçan herkesin geri dönmeye veya ölmeye zorlanmasını sağlarlar.
