...
- Kalemler ve silgiler. Renkli kalemler veya pastel boyalar da iyidir.
- En az bir d6 ve bir d20, ancak 6d6 ve 2d20 ideal olacaktır.

> Bundan sonra, kağıda **harita** olarak atıfta bulunacağız.
> Diğer kurallarda olduğu gibi, bir tablo sonucunu beğenmezseniz, tekrar atın veya istediğiniz gibi ayarlayın!

### Genel Bakış

1. Ormanı betimleyin.
2. Ormanın ruhunu betimleyin.
3. Ormanın İlgi Noktalarını (İN) oluşturun.
4. Ormanın patikalarını oluşturun.
5. Orman karşılaşmalarını oluşturun.
6. Ormanı adlandırın.
...
|         |                 |                 |
| ------- | --------------- | --------------- |
| **d20** | **Betimleme**   | **Betimleme**   |
| **1**   | Çorak           | Kadim           |
| **2**   | Kristal         | Uyanan          |
| **3**   | Hastalıklı      | Vızıltılı       |
| **4**   | Ölmekte         | Çürümekte       |
| **5**   | Çiçek Açan      | Sular Altında   |
| **6**   | Parlak          | Sisli           |
| **7**   | Kutsal          | Dondurucu       |
| **8**   | Yosunlu         | Donmuş          |
| **9**   | Karanlık        | Mantarlı        |
...
| **16**  | Boğucu          | İzole           |
| **17**  | Zamansız        | Sessiz          |
| **18**  | Haritalanmamış  | Tüten           |
| **19**  | Bozulmamış      | Güneşli         |
| **20**  | Kıvrımlı        | Vahşi           |

## Ormanın Ruhu

Bazı yönlerden, Orman tek bir varlıktır, beyni her ağaç ve bitkinin içinde canlıdır, diken ve dal ağıyla bağlıdır. Hayvanlar ve bitkiler onun uzuvlarıdır, isteklerini, arzularını, korkularını ve ihtiyaçlarını yönlendirir. Sınırları içinde yaşayan yaratıklar onun kanıdır, çok ihtiyaç duyulan savunmayı sağlayarak ve izinsiz girenleri geri püskürterek onun çağrısına cevap verir. Orman her zaman kendini ve çocuklarını koruyacaktır. [Özellikler](#özellikler) ve [Orman Gündemi](#orman-gündemi) tablolarında zar atın, sonuçları defterinize yazın. Bu, ormanda bulunan yaratıkların genel tavrını ve ormanın bir bütün olarak _ne istediğini_ betimler.
...
| **13**  | Besleyici   | Pasif          |
| **14**  | Gözlemci    | Kirletici      |
| **15**  | Arındırıcı  | Yırtıcı        |
| **16**  | Kararlı     | Kibirli        |
| **17**  | Mantıklı    | Katı           |
| **18**  | Keskin      | Dağınık        |
...
| **4**   | Temizlik       | Hastalık      |
| **5**   | Koruma         | Sömürü        |
| **6**   | Savunma        | Parçalanma    |
| **7**   | Keşif          | Kırılganlık   |
| **8**   | Kurtuluş       | Açgözlülük    |
| **9**   | Zenginleşme    | Cehalet       |
| **10**  | Evrim          | İstila        |
| **11**  | Genişleme      | İşgal         |
| **12**  | Uyum           | İzolasyon     |
| **13**  | Şifa           | Liderlik      |
| **14**  | Entegrasyon    | Baskı         |
| **15**  | Adalet         | Kirlilik      |
| **16**  | Başkalaşım     | Kıtlık        |
...
### İlgi Noktalarını (İN) Oluşturun

- Zindan haritasına **8-12 d6** zar atın, sayfadan düşen zarları yok sayın. Bunlar ormandaki İlgi Noktalarıdır (İN).
...
- Girişten başlayarak, her nokta arasında 1-4 yol çizin.
...
- Her patika için [Patika Türleri](#patika-türleri) tablosunda zar atın, sonuçları defterinize kaydedin.
...
| **6**   | Kuru Nehir Yatağı  | Uzak Şarkı Sesi    |
| **7**   | Peri Geçidi        | Cılız Kahkahalar   |
...
| **5**   | Dryad       | Ölme         |
| **6**   | Ettin       | Dövüşme      |
| **7**   | Gargoyle    | Yiyecek Toplama |
| **8**   | Yeşil Ejderha | Koruma     |
| **9**   | Boz Ayı     | Saklanma     |
...
| **16**  | Treant      | İyileşme     |
| **17**  | Tekboynuz   | Gözcülük     |
| **18**  | Will-o-Wisp | Gizlice Takip Etme |
| **19**  | Kurt        | İşkence      |
...
| **8**   | Açığa Çıkmış Atölye | Bağlı Yaratık                         |
| **9**   | Sular Altındaki Manastır | Kırık Portal                      |
...
| **6**   | Gizli Köy         | Eğitilmiş Hayvanlar Tarafından Korunur |
| **7**   | Yamaç Mağarası    | Yararsız Hayaletlerce Perili        |
| **8**   | Kof Ağaç          | Güçlü Bir Eser Saklar               |
| **9**   | Avcı Köşkü        | Avlanmak Yasaktır                   |
| **10**  | Bacaklı Kulübe    | Doğaüstü Bir Varlık Tarafından İkamet Edilir |
| **11**  | Sarmaşık Kaplı Kule | Ordu Kaçakları Tarafından İşgal Edilmiş |
| **12**  | Sundurma          | Tarikatçılarla İstila Edilmiş        |
| **13**  | Kereste Bölgesi   | Solgun Halkın Akşam Yemeği Mekanı   |
...
| **18**  | Zehirli Sporlar  | Sis Tarafından Silinen İzler  |
| **19**  | Trol İni         | Kemiklerden Büyüyen Ağaçlar   |
| **20**  | Dengesiz Zemin   | Will-o-Wisps Toplanır        |

## Örnek Orman

### Harita

[![Tıkla Büyüt!](/img/2e/forest-seed-example.webp "Büyütmek için tıkla"){:height="60%" width="60%"}](/img/2e/forest-seed-example.webp)

### Orman

**Betimleme**: Hastalıklı, Donmuş

Hastalık ve çürüme ile enfekte olmuş yoğun bir orman. Bazı kısımları donmuş katı haldedir.
...
**7**'deki keşişler, düşen her üyeleri için patikanın yanına taş yığınları bırakmışlar.
...
Bir zamanlar ormanın Batı ucundan bir nehir akardı, ancak bir kuraklıktan sonra kurudu. Dev örümcekler **8**'e giderken patikayı kullanır, yol boyunca ağlarını örerler.
...
**Tehlike**: _Özsu Tuzağı_, _Kristale Hapsedilmiş Hayalet_

Yuvarlak bir koru oluşturan kırmızı **ağaçlar**, fokurdayan bir özsu **birikintisini** çevreliyor. Birikintinin ortasında sivri, yeşil bir **nesne** zar zor görünüyor.
...
**Barınak**: _Münzevi Kulübesi_, _Hazır Bir Yemek Sunar_
...
- **Raf**: Üzerine gergin şekilde çeşitli hayvan derileri gerilmiş, kuruyor.
  - Birbirine dikilmiş deriler, iki takım koruyucu giysiye (1 Zırh) eşdeğerdir ve çevresel hasara karşı oldukça dayanıklıdır.

#### Kulübenin İçi

Çok sade, sadece basit bir **karyola** ve küçük bir yemek **masası** var.
...
**Tehlike**: _Donmuş Trol_, _Yanlış Giden Bir Büyü_

Dört patikanın kesiştiği noktada gri bir orman **tapınağı** duruyor. Merkezinde, iki devasa **heykel** güreşiyor gibi görünüyor.

- **Tapınak**: Tüm yakındaki bitki örtüsü cansız ve donuk, sanki tüm renk boşalmış gibi.
...
- **Kritik Hasar**: Hedefin yaralarından yosun ve dallar büyümeye başlar.

### 7 - Sular Altındaki Manastır
...
| ------- | ------------------------------------------------------------------------------------------ |
| **d20** | **Karşılaşma**                                                                             |
| **1**   | Küçük, sakallı bir adam çığlık atan bir kuzgunla tartışıyor. Gagasında parlak bir şey var. |
| **2**   | Bir dryad bir taşın üzerinde oturuyor, kollarında mor bir mantar dizili. Gözlerinde şiddet var. |
